...
export const smtSuperManConfig = new AlgorithmBuilder()
  ...
  .helpTextMap({
    ...
    4: "We loop over the first non-empty tie on %man%'s list.",
    5: 'We assign %man% to %woman%.',
    6: "We loop over men in ties to the right of %man% on %woman%'s list.",
    ...
    13: "We loop over the last non-empty tie on %woman%'s list.",
    ...
    17: 'We have a super-stable matching.',
