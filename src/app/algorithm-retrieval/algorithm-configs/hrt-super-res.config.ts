...
export const hrtSuperResConfig = new AlgorithmBuilder()
  ...
  .helpTextMap({
    ...
    12: 'Since %hospital% has been full at this point, we add it to the marked hospitals.',
    ...
    16: '',
    17: 'Due to %resident%, we know no super-stable matching exists ',
    18: '',
    19: 'Due to %hospital%, which has been full, being undersubscribed we know no super-stable matching exists. ',
    20: 'We have a super-stable matching.',
  })
  .code([
    'Set each resident to be free and hospital unsubscribed',
    'The marked hospitals listis initially empty.',
    ...
    'If some hospital that was marked is now undersubscribed:',
    "\tReturn 'no super-stable matching'",
